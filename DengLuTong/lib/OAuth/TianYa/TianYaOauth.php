<?php 
namespace DengLuTong\lib\OAuth\TianYa;
...
{ 
     ...
     *  
     * @access public 
     * @param mixed $akey 开放平台应用APP KEY 
     * @param mixed $skey 开放平台应用APP SECRET 
    ...
    { 
        ...
        return $this->oauth->post( 'http://xxx' , $param ); 
    }
    ...
    { 
        ...
        return $this->oauth->post( 'http://xxx' , $param , true ); 
    } 
    ...
    { 
        return $this->request_with_uid( 'http://xxx' ,  $uid_or_name ); 
    } 
